...
cd ~ && npm install connect connect-auth express jade less mongodb mongoose@1.4.0 monomi qs socket.io markdown-js async sprintf nodeunit nodemailer dateformat relative-date cluster imap node-uuid node-gd knox validator
