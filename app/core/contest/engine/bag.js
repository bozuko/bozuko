...
var BagEngine = module.exports = function(contest) {
    Engine.call(this, contest);
    this.configure();
};

inherits(BagEngine, Engine);

BagEngine.prototype.configure = function() {
 ...
 * @public
 */
BagEngine.prototype.generateResults = function(callback) {
    var self = this;
...
BagEngine.prototype.averageStep = function(contest_id, callback) {
    var self = this;
 ...
 * @returns true
 */
BagEngine.prototype.allowEntry = function(){
    return true;
};
 ...
 */
BagEngine.prototype.enter = function(tokens, callback) {
 ...
 * @public
 */
BagEngine.prototype.play = function(memo, callback) {
    var self = this;
