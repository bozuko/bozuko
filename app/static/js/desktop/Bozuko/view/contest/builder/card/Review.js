Ext.define('Bozuko.view.contest.builder.card.Review', {
            ...
            tpl : new Ext.XTemplate(
                ...
                '</div>',
                {
                    ...
                    entryMethod : function(){
                        ...
                        // lets get the icon
                        var img = me.up('contestbuilder')
                            .down('contestbuilderentry dataview')
                            .store.findRecord('type', me.contest.getEntryConfig().type )
                            .get('img');
                    ...
                    game : function(){
                        ...
                        // lets get the icon
                        var img = me.up('contestbuilder')
                            .down('contestbuildergame dataview')
                            .store.findRecord('game', me.contest.get('game') )
                            .get('img');
    ...
    refresh : function(){
        var me = this;
        me.form.update( me.contest.data );
        me.getEl().down('.prizes .expander').on('click', function(e,t){
