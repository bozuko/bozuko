Ext.define('Bozuko.model.Prize', {
    ...
    fields: [
        ...
        {name:'hide_expiration',type:'Boolean'},
        ...
        {name:'address_required',   type:'Boolean'},
        {name:'is_email',       type:'Boolean'},
        {name:'is_barcode',     type:'Boolean'},
        {name:'is_pdf',         type:'Boolean'},
        {name:'is_screen',      type:'Boolean'},
        {name:'pdf_image',      type:'String'},
        {name:'pdf_external',   type:'String'},
        {name:'pdf_image_only', type:'Boolean'},
